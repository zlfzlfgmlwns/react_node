  ...
  render() {
    ...
    const filteredComponents = (data) =>{
      ...
      return data.map((data)=>{
        return <Customer stateRefresh={this.stateRefresh}  key={data.id} id={data.id}image={data.image}name={data.name}birthday={data.birthday}gender={data.gender}job={data.job}/>
      })
    }
    return (
